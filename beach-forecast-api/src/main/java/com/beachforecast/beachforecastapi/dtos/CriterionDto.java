...
public record CriterionDto(
    ...
    @NotNull(message = "O peso do critério é obrigatório.") @DecimalMin(value = "0", message = "O peso mínimo é 0") @DecimalMax(value = "1", message = "O peso máximo é 1") Double weight) {
}
